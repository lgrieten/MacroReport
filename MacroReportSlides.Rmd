...
ggplot(plost_insuffqual, aes(x=device, y=insuff_q, fill="#1e8d95")) +
  geom_bar(stat="identity", fill = "#1e8d95")+theme_minimal() + theme(legend.position = "none") + xlab("Device manufacturers") + ylab("% of insufficient quality")  + geom_text(aes(label = insuff_q), vjust = 1.5, colour = "white")
