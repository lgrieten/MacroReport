...
The following tables shows some general metrics calculated out of your dataset. 
...
## Demography calculations | Distribution of genders
...
rbind(`Total number of participants:` = number_of_participants
    ...
    kable(caption = "Table with age based metrics") %>%
    kable_styling(
        bootstrap_options = c("hover", "condensed", "responsive"),
        full_width = F,
        font_size = 14)
...
## Measurement behavior - measurements throughout the day
...
ggplot(motivation_plot_total, aes(x=motivation, y=cnt, fill="#1e8d95")) +
