...
#configure input variables
    path <- file.path("/Volumes/GoogleDrive/Shared drives/9. Clinical/9.6 Data reporting/Spine")
...
ggplot(plot_right_1_df, aes(x=age, y=cnt, fill="#F8766D")) +
  geom_bar(stat="identity")+theme_minimal() + theme(legend.position = "none") + xlab("Age groups") + ylab("# subjects") + ggtitle("Distribution of age groups")
...
ggplot(plot_left_3_df, aes(x=wd, y=cnt_, fill="#F8766D")) +
  geom_bar(stat="identity")+theme_minimal() + theme(legend.position = "none", axis.text.x = element_text(angle = 30)) + scale_x_discrete(limits = plot_left_3_df$wd) + xlab("Week") + ylab("# of activatoins") + ggtitle("Activations on a weekly basis")
...
ggplot(plot_right_3_df, aes(x=hour_, y=cnt, fill="#F8766D")) +
  ...
  scale_x_discrete(limits=plot_right_3_df$hour_)+ xlab("Hour of the day") + ylab("# measurements") + ggtitle("Measurements taken throughout the day")
```
