...
#DF windown alculation for prescription durations
  ...
  df_prescription$today = as.Date("2021-10-28")
  total_prescription_days = sum(df_prescription$dur)
  Total_days_in_last_block = as.numeric(as.Date("2021-10-28")-max(df_prescription$activated_timestamp2))
  ...
  if(max(df_prescription$end_date) >= as.Date("2021-10-28"))
  {
...
p1 <- ggplot(df_window) +
          ...
          labs(color='Heart rhythm', title= paste("User ID:",UserID[i], "#rec:",nrow(df_window), "i",i)) +
