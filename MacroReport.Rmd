...
ggplot(plot_right_1_df, aes(x=age, y=cnt, fill="#F8766D")) +
  geom_bar(stat="identity")+theme_minimal() + theme(legend.position = "none") + xlab("Age groups") + ylab("# subjects") + ggtitle("Distribution of age groups") + geom_text(aes(label = cnt), vjust = 1.5, colour = "white")
...
ggplot(plot_left_2_df, aes(x=date, y=cnt, fill="#F8766D")) +
  geom_bar(stat="identity")+theme_minimal() + theme(legend.position = "none") + xlab("Date") + ylab("# activations") + ggtitle("Activations over time")
```
...
ggplot(plot_left_3_df, aes(x=wd, y=cnt_, fill="#F8766D")) +
  geom_bar(stat="identity")+theme_minimal() + theme(legend.position = "none", axis.text.x = element_text(angle = 90)) + scale_x_discrete(limits = plot_left_3_df$wd) + xlab("Week") + ylab("# of activatoins") + ggtitle("Activations on a weekly basis") + geom_text(aes(label = cnt_), size = 2, vjust = 1.5, colour = "white")
...
ggplot(plot_right_3_df, aes(x=hour_, y=cnt, fill="#F8766D")) +
  ...
  scale_x_discrete(limits=plot_right_3_df$hour_)+ xlab("Hour of the day") + ylab("# measurements") + ggtitle("Measurements taken throughout the day")+ geom_text(aes(label = cnt), vjust = 1.5, colour = "white")
```
...
ggplot(compliance_plot_total, aes(x=compliance, y=cnt, fill="#F8766D")) +
  geom_bar(stat="identity")+theme_minimal() + theme(legend.position = "none", axis.text.x = element_text(angle = 30)) + geom_text(aes(label = cnt), vjust = 1.5, colour = "white")   
...
ggplot(plot_right_4_df, aes(x=age, y=per_user_cnt, fill="#F8766D")) +
  geom_bar(stat="identity")+theme_minimal() + theme(legend.position = "none") + geom_text(aes(label = per_user_cnt), vjust = 1.5, colour = "white")
```
...
ggplot(plot_prescriptions_type, aes(x=type, y=cnt, fill="#F8766D")) +
  geom_bar(stat="identity")+theme_minimal() + theme(legend.position = "none",  axis.text.x = element_text(angle = 45, vjust=0.7)) + geom_text(aes(label = cnt), vjust = -1, colour = "black") + xlab("Type of prescriptions") + ylab("Amount of prescriptions") + ylim(0, max(plot_prescriptions_type$cnt)+30)
